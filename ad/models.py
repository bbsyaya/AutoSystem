...
class TaoBao(models.Model):
    ...
    item_url = models.URLField(max_length=300, blank=True,
                               help_text='商品详情页链接地址')
    ...
    item_click_short_url = models.URLField(max_length=300, blank=True,
                                           help_text='淘宝客短链接(300天内有效)')
    item_click_long_url = models.URLField(max_length=300, blank=True,
                                          help_text='淘宝客链接')
